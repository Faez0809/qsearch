    ...
    <footer className="app-footer">
      <div className="footer-grid">
        <section className="footer-column">
          ...
          <p className="footer-text">Credits: Product and Engineering Team.</p>
        </section>
        ...
        <section className="footer-column">
          ...
          <ul className="footer-links">
            ...
            <li><a href="#" className="footer-link">Solution Manager</a></li>
        ...
        <section className="footer-column">
          ...
          <ul className="footer-links">
            <li><a href="#" className="footer-link">support@qsearch.app</a></li>
